...
def transform_weather_data():
    ...
    with engine.begin() as conn:
        ...
        try:
            ...
            logger.info("Truncating analytics.current_weather table...")
            conn.execute(text("""
                TRUNCATE TABLE analytics.current_weather;
            """))

            logger.info("Inserting transformed data into analytics.current_weather...")
            conn.execute(text("""
            ...
            logger.info("Transformed latest weather observations into analytics.current_weather")
